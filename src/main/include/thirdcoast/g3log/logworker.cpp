...
#include "thirdcoast/g3log/g3log/active.hpp"
#include "thirdcoast/g3log/g3log/g3log.hpp"
#include "thirdcoast/g3log/g3log/future.hpp"
#include "thirdcoast/g3log/g3log/crashhandler.hpp"
...
namespace g3 {
   ...
   void LogWorkerImpl::bgSave(g3::LogMessagePtr msgPtr) {
      ...
      if (_sinks.empty()) {
         std::string err_msg {"thirdcoast/g3log/g3logworker has no sinks. Message: ["};
   ...
   void LogWorkerImpl::bgFatal(FatalMessagePtr msgPtr) {
      ...
      perror("thirdcoast/g3log/g3log exited after receiving FATAL trigger. Flush message status: ");
   }
