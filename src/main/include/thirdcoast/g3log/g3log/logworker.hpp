...
#include "thirdcoast/g3log/g3log/sinkwrapper.hpp"
#include "thirdcoast/g3log/g3log/sinkhandle.hpp"
#include "thirdcoast/g3log/g3log/filesink.hpp"
#include "thirdcoast/g3log/g3log/logmessage.hpp"
#include <memory>
...
namespace g3 {
   ...
   class LogWorker final {
    ...
    public:
       ...
       */
      std::unique_ptr<FileSinkHandle> addDefaultLogger(const std::string& log_prefix, const std::string& log_directory, const std::string& default_id = "thirdcoast/g3log/g3log");
